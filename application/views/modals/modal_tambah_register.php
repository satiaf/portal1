...
<div class="col-md-offset-1 col-md-12 col-md-offset-1 well">
  ...
  <form class="form-horizontal" action="<?php echo base_url('Data_berita/tambah') ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="input-group form-group">
      ...
      <select name="id_tipe_berita" class="form-control" aria-describedby="sizing-addon2">
        ...
        foreach ($dataTipe_berita as $tipe_berita) {
          ?>
          <option value="<?php echo $tipe_berita->id; ?>">
            <?php echo $tipe_berita->tipe_berita; ?>
          </option>
          <?php
        }
        ?>
    ...
    <div class="input-group form-group">
      ...
      <textarea rows="6" class="form-control" placeholder="Ringkasan Berita" name="ringkasan_berita" aria-describedby="sizing-addon2"></textarea>
    </div>
    ...
    <div class="form-group">
      <div class="col-md-12">
        <button type="submit" class="form-control btn btn-primary"> Tambah Data</button>
      </div>
    </div>
  </form>
</div>
