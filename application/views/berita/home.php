...
<div class="box">
  <div class="box-header">
    <div class="col-md-6" style="padding: 0;">
        <button class="form-control btn btn-primary" data-toggle="modal" data-target="#tambah-berita"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Data</button>
    </div>
    <!-- <div class="col-md-3">
...
<?php
  $data['judul'] = 'Berita';
  $data['url'] = 'Berita/import';
  echo show_my_modal('modals/modal_import', 'import-berita', $data);
?>