...
<html lang="en">
  ...
  <head>
    ...
    <title>Portal Berita | Labuhanbatu Selatan</title>
...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <h4>Portal<span> Berita</span></h4>
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              <li class="scroll-to-section"><a href="#top" class="active">Home</a></li>
              <li class="scroll-to-section"><a href="#persyaratan">Persyaratan</a></li>
              <!-- <li class="scroll-to-section"><a href="#services">Services</a></li> -->
              <!-- <li class="scroll-to-section"><a href="#portfolio">Portfolio</a></li> -->
              <li class="scroll-to-section"><a href="#isi">Isi</a></li>
              <li class="scroll-to-section"><div class="main-red-button"><a href="#login">Login</a></div></li> 
            </ul>        
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                ...
                <h2><em>Pastikan</em></h2>
                <p>Anda telah terdaftar sebagai anggota!, jika belum silahkan registrasi dan melengkapi syarat!.<a rel="nofollow" href="#persyaratan" target="_parent"> Pelajari Lebih Lanjut!</a>.</p>
  ...
  <div id="persyaratan" class="about-us section">
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
              ...
              <div class="col-lg-4">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                  ...
                  <div class="right-text">
                    <h4>Melengkapi Persyaratan</h4>
                    <p>Lengkapi persyaratan yang telah di tentukan.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.9s">
                  ...
                  <div class="right-text">
                    ...
                    <p>Dapatkan Username & Password pada admin jika telah terdaftar.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
  ...
  <div id="isi" class="our-blog section">
    <div class="container">
            ...
            <div class="info">
              <div class="inner-content">
                ...
                <div class="main-blue-button">
                  <a href="<?php echo base_url('Formulir'); ?>">Isi Formulir</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 align-self-center wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <div class="section-heading">
            <h2>Form Login</h2>
            <p>Telah memiliki akun, Silahkan login untuk melakukan upload berita.<br>
            Jika belum! <a style="color: white; font-style: italic;" href="#persyaratan"><strong>Pelajari lebih lanjut!</strong></a></p>
            <!-- <div class="phone-info">
              <h4>Hubungi Kami: <span><i class="fa fa-phone"></i> <a href="#">010-020-0340</a></span></h4>
            </div> -->
          </div>
        </div>
        <div class="col-lg-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <form id="contact" action="<?php echo base_url('Auth/login'); ?>" method="post">
            <div class="row">
              <div class="col-lg-12">
                <fieldset>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.25s">
          <p>© Copyright 2021 Diskominfo Labusel. All Rights Reserved. 
          
          <br>Design: <a rel="nofollow" href="http://diskominfo.labuhanbatuselatankab.go.id/">Diskomifo Labuhanbatu Selatan</a></p>
        </div>
      </div>
    </div>
  </footer>
