    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <span class="nav-item">
                    <a class="btn-outline-sm" href="<?php echo base_url(); ?>Daftar">Daftar</a>
                </span>
            </div>
    ...
    <header id="header" class="ex-2-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Log In</h1>
                   <p>Jika belum memiliki akun, harap untuk <a class="white" href="<?php echo base_url(); ?>Daftar">Daftar</a> terlebih dahulu.</p> 
                    <!-- Sign Up Form -->
                    <div class="form-container">
                        <form class="logInForm validate-form" action="<?php echo base_url('Auth/login'); ?>" method="post" data-toggle="validator">
