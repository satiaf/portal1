...
class Test_crud extends AUTH_Controller {
	...
	public function index() {
		...
		$data['page'] = "test_crud";
		$data['judul'] = "TEST CRUD";

		$data['modal_tambah_test_crud'] = show_my_modal('modals/modal_tambah_test_crud', 'tambah-test_crud', $data);

		$this->template->views('test_crud/', $data);
	}
